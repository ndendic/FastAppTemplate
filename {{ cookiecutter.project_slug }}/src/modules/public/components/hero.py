...
def Illustration():
    return Svg(
        ...
        data_src="https://cdn.undraw.co/illustrations/website_27ju.svg",
...
def HeroSection():
    return Section(
        Div(
                    ...
                    Div(
                        ...
                        Div(
                            Button(
                                "Try for free",
                                cls=ButtonT.primary
                                + "text-sm md:text-lg px-6 md:px-8 py-3",
                            ),
                        ),
            ...
            Div(
                Illustration(),
                cls="hidden ml-2 lg:mt-0 lg:col-span-5 xl:col-span-4 lg:flex",
            ),
