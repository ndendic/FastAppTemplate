        ...
        Div(
            ...
            Div(
                Div(
                    H1(
                        "Welcome back",
                        cls="text-xl font-bold leading-tight tracking-tight text-gray-900 sm:text-2xl dark:text-white",
                    ),
                    Div(
                        A(
                            Svg(
                            ...
                            "Log in with Google",
                            href="oauth/github",
                            cls="w-full inline-flex items-center justify-center py-2.5 px-5 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-gray-900 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700",
                        ),
                        A(
                            Svg(
                                G(
                                    ...
                                    clip_path="url(#clip0_13183_29163)",
                                ),
                                Defs(
                                    Rect(
                                        width="20",
                                    ...
                                    id="clip0_13183_29163",
                                ),
                                viewbox="0 0 21 20",
                                fill="none",
                                xmlns="http://www.w3.org/2000/svg",
                                cls="w-5 h-5 mr-2 text-gray-900 dark:text-white",
                            ),
                            "Log in with Apple",
                            href="#",
                            cls="w-full inline-flex items-center justify-center py-2.5 px-5 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-gray-900 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700",
                        ),
                        cls="items-center space-y-3 sm:space-x-4 sm:space-y-0 sm:flex",
                    ),
                    Div(
                        Div(cls="w-full h-0.5 bg-gray-200 dark:bg-gray-700"),
                        Div(
                            "or",
                            cls="px-5 text-center text-gray-500 dark:text-gray-400",
                        ),
                        Div(cls="w-full h-0.5 bg-gray-200 dark:bg-gray-700"),
                    ...
                    Form(
                        ...
                        Div(
                            ...
                            A(
                                ...
                                cls="text-sm font-medium text-primary-600 hover:underline dark:text-primary-500",
                            ),
                        ...
                        Button(
                            ...
                            type="submit",
                            cls="w-full text-white bg-primary-600 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800",
                        ),
                        P(
                            ...
                            A(
                                "Sign up here",
                                href="/auth/register",
                                cls="font-medium text-primary-600 hover:underline dark:text-primary-500",
                            ),
                            cls="text-sm font-light text-gray-500 dark:text-gray-400",
                        ),
                        method="post",
                        cls="space-y-4 lg:space-y-6",
                    ),
                    cls="p-6 space-y-4 lg:space-y-6 sm:p-8",
                ),
                cls="w-full col-span-6 mx-auto bg-white rounded-lg shadow dark:bg-gray-800 md:mt-0 sm:max-w-lg xl:p-0",
            ),
